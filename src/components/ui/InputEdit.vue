<template>
  <div class="flex flex-col">
    ...
    <div
      class="flex relative h-3 flex-row items-center border-[#6C757D] md:w-56 sm:w-37.5 w-20 rounded-md border-0.1 bg-transparen focus-within:ring focus:shadow-shadow outline-none"
    >
