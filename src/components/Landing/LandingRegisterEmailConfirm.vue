<template>
  <div
    :ref="modalWrapper"
    :class="['modal-wrapper', { 'modal-wrapper--active': isModalActive('confirmModalActive') }]"
    @click="closeModal"
  >
    <LandingModal
      class="w-33 h-23.4 z-10 fixed flex flex-col items-center justify-center bg-gray rounded-lg"
